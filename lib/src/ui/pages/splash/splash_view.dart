...
import 'package:samudramanthan/src/data/repositories_impl/images_repository_impl.dart';
import 'package:samudramanthan/src/ui/pages/game/game_view.dart';
import 'package:samudramanthan/src/ui/pages/splash/circle_transition_clipper.dart';
import 'package:samudramanthan/src/ui/utils/colors.dart';
          ...
          builder: (_, orientation) {
            ...
            return AnimatedBuilder(
                    ...
                    Center(
                      child: Transform.scale(
                        ...
                        child: Opacity(
                          ...
                          child:Image.asset("assets/images/logobgb.png",width: 400,height: 400,
              ...
              child: Transform.rotate(
                angle: math.pi * 180,
                child: Image.asset(
                  'assets/images/splashscreen.png',fit: BoxFit.fill,alignment: Alignment.bottomCenter,
                ),
              ),
            );
          },
